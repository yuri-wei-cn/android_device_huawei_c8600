...
-include vendor/huawei/c8600/BoardConfigVendor.mk

PRODUCT_SPECIFIC_DEFINES += TARGET_PRELINKER_MAP=device/huawei/c8600/files/prelink-linux-arm.map
...
BOARD_VENDOR_QCOM_GPS_LOC_API_HARDWARE := C8600
...
TARGET_OTA_ASSERT_DEVICE := c8600,C8600
PRODUCT_BUILD_PROP_OVERRIDES += TARGET_BOOTLOADER_BOARD_NAME=C8600
TARGET_BOOTLOADER_BOARD_NAME := C8600

TARGET_PREBUILT_KERNEL := device/huawei/c8600/kernel
